...
import { readApiEndpoint, writeApiEndpoint } from "../service/Endpoints";
...
function Account(props) {
    ...
    const [account, setAccount] = useState({ balance: 0.0 });
    ...
    function loadData() {
        getData(
            readApiEndpoint + "/accounts/" + accName,
            data => {
                setAccount(data);
            },
            null
        ...
        getData(
            readApiEndpoint + "/accounts/" + accName + "/transactions",
            data => {
                setData(data);
            },
            null
        ...
        <div>
            <div className="row mb-3">
                <div className="col">
                    <h3>Account</h3>
                    {accName}{" "}
                    <label className="ml-2">{account.balance.toFixed(2)}</label>
                </div>
            </div>
            <div className="row">
                <div className="col">
